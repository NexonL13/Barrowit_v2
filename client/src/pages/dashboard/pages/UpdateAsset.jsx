...
const UpdateAsset = () => {
  ...
  const fetchAsset = async () => {
    const { data } = await axios.get(`http://localhost:3000/asset/${params.id}`)
    setAsset(data)
  }
  ...
  const onSubmit = async (values) => {
    await axios.put(`http://localhost:3000/asset/${params.id}`, values).then((res) => {
  ...
  <div className="lg:grid lg:min-h-screen lg:grid-cols-none">
    ...
    >
      <div className="max-w-xl lg:max-w-3xl">
        <Formik
         initialValues={asset ?? initialValues}
